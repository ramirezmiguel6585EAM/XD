...
export const initialProducts = [
  ...
  },
  {
    ...
    categoryLabel: "Electronics",
    quantity: 2,
    description: "Brand new AirPods Pro with active noise cancellation and spatial audio.",
    details: ["Wireless charging case", "Active Noise Cancellation", "Spatial audio with dynamic head tracking", "Sweat and water resistant"],
    meetupInfo: "Public meetup at a coffee shop in Midtown Manhattan.",
    location: "New York, NY",
    zipCode: "10001",
  ...
  },
  {
    ...
    categoryLabel: "Home & Garden",
    quantity: 1,
    description: "Beautiful vintage rocking chair with a warm wooden finish. Minor scratches.",
    details: ["Solid oak wood", "Comfortable cushioned seat", "Classic design"],
    meetupInfo: "Pick up at my driveway in Brooklyn.",
    location: "Brooklyn, NY",
    zipCode: "11211",
  ...
  {
    id: "30",
    title: "Collectible Funko Pop – Batman",
    price: 30,
    originalPrice: 55,
    discount: "45% OFF",
    condition: "Good",
    ...
    categoryLabel: "Collectibles",
    quantity: 1,
    description: "Funko Pop figure of Batman, limited edition. Slightly worn box.",
    details: ["4-inch vinyl figure", "Limited edition release", "Box in decent condition"],
    meetupInfo: "Meet at a public library in Brooklyn.",
    location: "Brooklyn, NY",
    zipCode: "11215",
  ...
  },
  {
    ...
    categoryLabel: "Home & Garden",
    quantity: 1,
    description: "Stainless steel food processor with multiple blades, barely used.",
    details: ["8‑cup capacity", "S‑shaped blade", "Pulse function"],
    meetupInfo: "Pickup at my apartment lobby in Queens.",
    location: "Queens, NY",
    zipCode: "11101",
    timeListed: "Listed 1 hour ago",
    views: 3,
  ...
  },
  {
    ...
    categoryLabel: "Electronics",
    quantity: 1,
    description: "Canon M50 camera with kit lens, lightly used, includes battery and charger.",
    details: ["24.1MP APS‑C sensor", "Dual Pixel AF", "4K video"],
    meetupInfo: "Public meetup at a coffee shop in Manhattan.",
    location: "New York, NY",
    zipCode: "10012",
    timeListed: "Listed 2 hours ago",
    views: 6,
  ...
  },
  {
    ...
    categoryLabel: "Video Games",
    quantity: 2,
    description: "Nintendo 3DS XL handheld console, gray, includes two games.",
    details: ["16GB storage", "Two pre-installed games", "Battery in good condition"],
    meetupInfo: "Meet at a park near Union Square.",
    location: "New York, NY",
    zipCode: "10003",
    timeListed: "Listed 4 hours ago",
    views: 10,
  ...
  },
  {
    ...
    categoryLabel: "Electronics",
    quantity: 3,
    description: "Fitbit Charge 5 fitness tracker, black, includes charger.",
    details: ["Built‑in GPS", "Sleep tracking", "Heart rate monitor"],
    meetupInfo: "Meet at a coffee shop in Brooklyn Heights.",
    location: "Brooklyn, NY",
    zipCode: "11201",
    timeListed: "Listed just now",
    views: 0,
  ...
  {
    id: "36",
    title: "Vintage Vinyl Record – Thriller (Michael Jackson)",
    price: 40,
    originalPrice: 80,
    discount: "50% OFF",
    condition: "Good",
    ...
    categoryLabel: "Collectibles",
    quantity: 1,
    description: "Original 1982 Thriller vinyl LP, clean, minor wear on edge.",
    details: ["12‑inch 33 RPM", "Original pressing", "Cover in good condition"],
    meetupInfo: "Meet at a record store in Greenwich Village.",
    location: "New York, NY",
    zipCode: "10012",
    timeListed: "Listed 2 hours ago",
    views: 5,
  ...
  },
  {
    ...
    categoryLabel: "Fashion",
    quantity: 1,
    description: "Lightweight insulated jacket, size Large, minor wear on sleeves.",
    details: ["Down alternative insulation", "Water resistant shell", "Packable"],
    meetupInfo: "Public meetup at a park in Upper West Side.",
    location: "New York, NY",
    zipCode: "10024",
    timeListed: "Listed 2 hours ago",
    views: 3,
  ...
  },
  {
    ...
    categoryLabel: "Electronics",
    quantity: 1,
    description: "Classic Polaroid instant camera, works, includes film pack.",
    details: ["Automatic flash", "Film pack (8 shots) included"],
    meetupInfo: "Public meetup at a park in Brooklyn.",
    location: "Brooklyn, NY",
    zipCode: "11201",
    timeListed: "Listed 2 hours ago",
    views: 6,
